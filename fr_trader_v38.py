...
class TradingConfig:
    ...
    def validate_config(self):
        ...
        if self.MAX_RISK_PERCENT <= 0 or self.MAX_RISK_PERCENT > 0.2:
            validation_errors.append("MAX_RISK_PERCENT should be between 0 and 0.2 (current: {})".format(self.MAX_RISK_PERCENT))
